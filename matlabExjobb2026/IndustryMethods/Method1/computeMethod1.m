function m1 = computeMethod1(dm, dc, verboseQuarter, bs, pnl)
% computeMethod1  Compute Method 1 (actual-rate) FX impacts for the full period.
%
%   m1 = computeMethod1(dm, dc)
%   m1 = computeMethod1(dm, dc, 'YYYY-Qn')          % debug print one quarter
%   m1 = computeMethod1(dm, dc, '', bs, pnl)         % reuse pre-computed bs/pnl
%
% Orchestrates:

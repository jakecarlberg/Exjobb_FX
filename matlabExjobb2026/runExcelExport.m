...
% -------------------------------------------------------------------------
hdrA = {'Year', ...
  'PAM_TI [SEK] (Eq.4.45)', 'PAM_OCI [SEK] (Eq.4.46)', 'PAM_CC_total [SEK] (Eq.4.47)', ...
  ...
  'Diff_TI_PAMvM2weekly [SEK]', 'Diff_OCI_PAMvM2weekly [SEK]', ...
  'Diff_TI_PAMvM2monthly [SEK]', 'Diff_OCI_PAMvM2monthly [SEK]', ...
  'Diff_TI_PAMvM2quarterly [SEK]', 'Diff_OCI_PAMvM2quarterly [SEK]'};
aData = [num2cell(uniqueYears), num2cell([...
  TI_a, OCI_a, CCt_a, CCtr_a, CCtl_a, CCt_LY_a, CCtr_LY_a, CCtl_LY_a, ...
  m2TI_w_a, m2OCI_w_a, m2TI_m_a, m2OCI_m_a, m2TI_qt_a, m2OCI_qt_a, ...
  TI_a-m2TI_w_a, OCI_a-m2OCI_w_a, ...
  TI_a-m2TI_m_a, OCI_a-m2OCI_m_a, ...
  TI_a-m2TI_qt_a, OCI_a-m2OCI_qt_a])];
totRow = [{'TOTAL'}, num2cell([...
  sum(TI_a), sum(OCI_a), sum(CCt_a), sum(CCtr_a), sum(CCtl_a), sum(CCt_LY_a), sum(CCtr_LY_a), sum(CCtl_LY_a), ...
  sum(m2TI_w_a), sum(m2OCI_w_a), sum(m2TI_m_a), sum(m2OCI_m_a), sum(m2TI_qt_a), sum(m2OCI_qt_a), ...
  sum(TI_a)-sum(m2TI_w_a), sum(OCI_a)-sum(m2OCI_w_a), ...
  sum(TI_a)-sum(m2TI_m_a), sum(OCI_a)-sum(m2OCI_m_a), ...
  sum(TI_a)-sum(m2TI_qt_a), sum(OCI_a)-sum(m2OCI_qt_a)])];
...
qData = [qLabels, num2cell([...
  TI_q, OCI_q, CCt_q, CCtr_q, CCtl_q, CCt_LY_q, CCtr_LY_q, CCtl_LY_q, ...
  m2TI_w_q, m2OCI_w_q, m2TI_m_q, m2OCI_m_q, m2TI_qt_q, m2OCI_qt_q, ...
  TI_q-m2TI_w_q, OCI_q-m2OCI_w_q, ...
  TI_q-m2TI_m_q, OCI_q-m2OCI_m_q, ...
  TI_q-m2TI_qt_q, OCI_q-m2OCI_qt_q])];
